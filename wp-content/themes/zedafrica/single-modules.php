...
body.single.single-modules div#wrapperX,
...
a#get_started:hover {
    ...
    border: 0px solid #00a8eb !important;
...
*/
    ...
    <div id="MainModuleSliderPro" class="MainModuleSliderPro container-fluid" style="display: block;">
      ...
      <script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/library/js/jquery.sliderPro.js"></script>
                    ...
                    <div class="sp_tideA tideA1">
                      <div class="container">
                        ...
                        <div class="content-block row">
                          <div class="col-12">
                            <!-- <h1 class="slider_title"><?php the_sub_field( 'module_title' ); ?></h1> -->                      
                          </div>
                                                  
                          <div class="col-md-4 offset-md-1 col-sm-12">
                            <content>
                              <article class="module_box_of_text">
                                <h1 class="slider_titleX"><?php the_sub_field( 'module_title' ); ?></h1>
                          ...
                          <?php if ( $image ) { ?>
                            <div class="module_image_X col-md-6 col-sm-12">
  ...
  <?php } else { ?>
    ...
    <style type="text/css">div#preloader{display: none;}</style>
...
<?php  } ?>
      ...
      <script type="text/javascript">
          jQuery( document ).ready(function($) {
            $("#preloader").addClass("ficha");
            $("#MainModuleSliderPro").addClass("onyesha");
            // $('#preloader').hide();
            // $('#MainModuleSliderPro').show();
          });
      </script>
