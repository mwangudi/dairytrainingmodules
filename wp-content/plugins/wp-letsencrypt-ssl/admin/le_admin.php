...
class WPLE_Admin
{
    ...
    public function wple_upgrade_block( &$html )
    {
      ...
      <div id="wple-upgradepro">';
        ...
        // }
        $html .= '</div>';
        $html .= '<div class="wple-hire-expert"><a href="https://wpencryption.com/hire-ssl-expert/" target="_blank"><b>Hire an expert</b> for safe & secure migration to HTTPS (<b>ONE YEAR PRO LICENSE FREE</b>) <span class="dashicons dashicons-external"></span></a></div>';
